  ...
  return (
    <div className={styles.page}>
      <header className={styles.header}>
        <span className={styles.logo}>Sukima</span>
      </header>

      <section className={styles.hero}>
        <p className={styles.eyebrow}>会議調整、もう疲れた人へ。</p>
      ...
      <section className={styles.ctaBottom}>
        <p className={styles.ctaBottomText}>さあ、隙間を埋めよう。</p>
        <Link href="/app" className={styles.cta}>
          今すぐはじめる
        </Link>
      </section>
